...
<head>
    ...
    <link rel="stylesheet" href="{{asset('theme/global/fonts/font-awesome/font-awesome.min.css')}}">
    <!-- Scripts -->
...
<body class="animsition page-profile dashboard site-menubar-unfold">
        ...
        {{-- <div id="app"> --}}
        {{-- Header --}}
        @include('backend.layouts.site.header')
        {{-- slideBar --}}
        @include('backend.layouts.site.sliderBar')
        @yield('content')
        @include('backend.layouts.site.footer')
        {{-- </div> --}}
